...
public class UpdatePersonScreen extends BaseModifyPersonScreen {
    ...
    public UpdatePersonScreen(int personId, String personName, String bLocation, Date bDate, String dLocation, Date dDate, String wikiURL, boolean personIsFemale) {
    ...
    protected void execQuery(Long birthLocationId, Long deathLocationId, Date birthDate, Date deathDate, String link) throws AtlasServerException {
        ...
        if (personName.equals(name.getText())) {
    ...
    public static void main(String[] args) throws IOException, AtlasServerException {
        ...
        new UpdatePersonScreen(123, "paz", "London", new Date(325454643), "London", new Date(1253254), "http://www.etan.rona", true);
    }
}
