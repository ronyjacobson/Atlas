...
/** 
 * file names, regex patterns and category names
 * */
public class ParserConstants {
	...
	public static final String[] REQUIRED_FILES = { YAGO_DATE_FACTS_TSV,
			YAGO_FACTS_TSV, YAGO_TRANSITIVE_TYPE_TSV, YAGO_LABELS_TSV,
			YAGO_WIKIPEDIA_INFO_TSV, YAGO_LITERAL_FACTS_TSV,
			YAGO_GEONAMES_ENTITY_IDS_TSV, CITIES1000_TXT };
