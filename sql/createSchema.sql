...
-- Schema DbMysql06
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `DbMysql06` ;
...
CREATE TABLE IF NOT EXISTS `DbMysql06`.`user` (
  ...
  CONSTRAINT `fk_user_location1`
    ...
    REFERENCES `DbMysql06`.`location` (`location_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `DbMysql06`.`person` (
  ...
  INDEX `bornOnDate_idx` (`wasBornOnDate` ASC),
  INDEX `diedOnDate_idx` (`diedOnDate` ASC),
